          ...
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="640" bgcolor="#FFFFFF">
            ...
            <tr>
              <td style="padding:0px 20px 20px 20px; color:#777777;">
                <div style="font-size:18px; color:#777777;">Dear $epayname</div>
                 <div>&nbsp;</div>
                 <div style="font-size:18px; color:#777777;">Your order $eorderid has been completed. </div>
                <br />
      ...
      <tr>
        <td>
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="640" bgcolor="#FFFFFF">
            ...
            <tr>
              <td style="padding:0px 20px 20px 20px; color:#777777;">
                <div style="font-size:18px; color:#777777;">Dear Admin </div>
                 <div>&nbsp;</div>
                 <div style="font-size:18px; color:#777777;">Order $eorderid is marked as completed by $membername. <a href="$domain/safeside/order_detail.php?oid=$eorderid">Click here</a> to check the details.</div>
                <br />
              </td>
            </tr>
...
$subject2 = "Order ".$eorderid." Completed";
