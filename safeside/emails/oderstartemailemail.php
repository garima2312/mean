            ...
            <tr>
              <td style="padding:0px 20px 20px 20px; color:#777777;">
                <div style="font-size:16px; color:#777777;">Dear $epayname</div>
                 <div>&nbsp;</div>
                 <div style="font-size:16px; color:#777777;">We received your payment against order $eorderid, thank you! </div>
                <br />
                <div  style="font-size:16px; color:#777777;">
Your order $eorderid starts on $odstrt_date. and your ETA is : $eta <br> </div>
              </td>
            </tr>
...
eot;
$to = $epayemail;
$subject = "Start Date for Order ".$eorderid."";
