<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	      	<h2 class="page-header">All Comments On Assigned Projects </h2>
	      	 	<div class="table-responsive">
 <?php 	$num_rec_per_page=40;
 ...
 $sqlcomtal ="SELECT DISTINCT oid ,MAX(comment_time) FROM ph_order_chat WHERE (postby ='user' OR postby ='team_member' ) GROUP BY oid ORDER BY MAX(comment_time) DESC,oid LIMIT $start_from, $num_rec_per_page";
				...
				$page  = $_GET["page"];
				if($page >1){$count=40*($page-1)+1;}else{
				$count=1;}
					...
					$sql_tmid = "SELECT * FROM ph_assign_project WHERE tmid ='$adminid' AND projects_id='".$rowcomtal["oid"]."'";
