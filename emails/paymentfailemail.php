...
<td id="header_wrapper" style="padding: 10px 25px; display: block;">
												<h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'>Payment Failed</h1>
											</td>
										</tr></table>
<!-- End Header -->
</td>
...
<p style="margin: 0 0 16px;">Your Payment Status</p>
<p style="margin: 0 0 16px;">Your Payment has been failed against the order $eorderid. This can be happen with many reasion. Please try again.</p>
<p style="margin: 0 0 16px;">Click here to make payment again</p>
<p style="margin: 0 0 16px;"><a href="$domain/order_detail?oid=$emorderid" style="font-size:16px; background-color:#00bcd4; color:#ffffff; font-size:16px; padding:10px 20px;border-radius:4px; text-decoration:none;">Pay Now</a></p>
...
eot;
$to = $epayemail;
$subject = "Payment failed against order ".$eorderid."";
