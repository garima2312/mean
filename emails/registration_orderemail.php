...
<td id="header_wrapper" style="padding: 10px 25px; display: block;">
												<h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'>Login Detail</h1>
											</td>
</tr></table>
<!-- End Header -->
</td>
...
<p style="margin: 0 0 16px;">Thank you for your request, we will use your email address $email to notify you about replies to your projects and status updates.</p>

<h2 style='color: #00ACC1; display: block; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 130%; margin: 16px 0 8px; text-align: left;'>Here is your login details.</h2>
<ul>
<li>
<strong>Login:</strong> <span class="text" style='color: #505050; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif;'>$email</span>
</li>
            <li>
<strong>Password:</strong> <span class="text" style='color: #505050; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif;'>$randpassword</span>
</li>
    </ul>

	<p style="margin: 0 0 16px;">You can change your password any time by logging to your client area section <a href="https://psd2html5.co/login">Login</a> </p>
...
<h2 style='color: #737373; display: inline-block; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 130%; margin: 16px 0 8px; text-align: left;'>Other Guidelines :</h2> $message
