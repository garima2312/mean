...
<td id="header_wrapper" style="padding: 10px 25px; display: block;">
												<h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'> $type Comment on $eorderid</h1>
											</td>
										</tr></table>
<!-- End Header -->
</td>
...
<strong style="font-color:#FFF" id="dat~$orderid.'dat~'.$cmuserid.'dat~'.$eorderid" class="local_mail" ></strong>
