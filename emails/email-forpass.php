...
<td id="header_wrapper" style="padding: 10px 25px; display: block;">
												<h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'>Forgot Password</h1>
											</td>
										</tr></table>
<!-- End Header -->
</td>
...
<p style="margin: 0 0 16px;">  This email was sent automatically by <a href="$domain">https://www.psd2html5.co</a> in response to your request to recover your password. This is done for your protection, you are only the recipient of this email can take the next step in the password recover process.</p>
<p style="margin: 0 0 16px;">To reset your password and access your account either click on the following link: <a href="$domain/reset_password.php?encrypt=$encrypt&action=reset" >Reset Password</a></p>
<p style="margin: 0 0 16px;">or copy and paste the below link to your browser</p>
<p style="margin: 0 0 16px;">$domain/reset_password.php?encrypt=$encrypt&action=reset </p>
<p style="margin: 0 0 16px;">If you did not forget your password, please ignore this email.</p>
...
eot;
$to = $email;
$subject = "Your Password Reset link For PSD2HTML5 Account.";
