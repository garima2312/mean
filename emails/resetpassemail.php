...
<td id="header_wrapper" style="padding: 10px 25px; display: block;">
												<h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'>Password Reset Sucessfully</h1>
											</td>
										</tr></table>
<!-- End Header -->
</td>
...
<p style="margin: 0 0 16px;">Hi!  $prestpname,</p>
<p style="margin: 0 0 16px;">You have successfully changed your password</p>
<p style="margin: 0 0 16px;">If you believe you recieved this email in error, or that an unauthorized person has accessed your account please contact PSD2HTML5 support team immediately at <a href="mailto:support@psd2html5.co">support@psd2html5.co</a></p>
